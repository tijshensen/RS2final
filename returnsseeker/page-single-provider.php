...
<body class="returnsseeker rs-single-provider">
	...
	<section class="providers-banner-section">
		<div class="container">
			<div class="row relative-block">
				...
				<div class="col-12">
					<h1 class="h1 company-card-title">Betterment<span> Review</span></h1>
					<?php include('_single-provider-card.php'); ?> 
				</div>
			</div>
		</div>
	</section>
		...
		<div class="sticky-menu">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-5 sticky-menu-link-block">
						<img src="./img/logo-menu-Betterment.png" alt="" class="sticky-menu-company-logo">

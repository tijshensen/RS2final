	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="rs-description">Get discounts on online healthcare products & services sent to your inbox.<br/>(We'll only email if we have something REALLY good for you.)</div>
			</div>
	...
	<div class="container">
		<div class="row footer-nav">
			...
			<div class="col-md-3 footer-nav-block">
				<a class="footer-logo-link" href="page-index.php">
			...
			<div class="col-md-3 footer-nav-block">
				...
				<ul class="footer-nav-list">
					...
					<li class="footer-nav-item"><a href="page-about.php">Company</a></li>
			...
			<div class="col-md-3 footer-nav-block" >
				...
				<ul class="footer-nav-list">
					...
					<li class="footer-nav-item"><a href="#">Primary Care</a></li>
					<li class="footer-nav-item"><a href="#">Telehealth</a></li>
					<li class="footer-nav-item"><a href="#">Online Therapy</a></li>
				</ul>
			</div>
		...
		<div class="row">
			<div class="copyright col-12">
				© Copyright 2020 - All Rights Reserved. Privacy Policy - XML Sitemap.  ReliefSeeker.com
			</div>

	...
	<div class="container">
		...
		<div class="search-card-container">
			<div class="search-card">
				<img src="./svg/001-plaster.svg" alt="" class="search-card-img">
				<div class="search-card-name">Get Care Now</div>
				<div class="search-card-description">Search by category to find the best online care providers.</div>
				<a href="#" class="btn btn-cta">SEARCH BY CATEGORY</a>
			</div>
			<div class=" search-card">
				<img src="./svg/001-plaster.svg" alt="" class="search-card-img">
				<div class="search-card-name">Compare & Save</div>
				<div class="search-card-description">Search by Treatment to find the right provider for you.</div>
				<a href="#" class="btn btn-cta">Search by treatment</a>
			</div>
			<div class="search-card">
				<img src="./svg/001-plaster.svg" alt="" class="search-card-img">
				<div class="search-card-name">Know Your Options</div>
				<div class="search-card-description">Search by condition to discover every available online treatment.</div>
				<a href="#" class="btn btn-cta">Search by condition</a>
			</div>
		</div>
	</div>
</section>
...
<section class="partners-section">
	<div class="container">
		...
		<div class="partners-container">
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./img/logo-help.png" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./img/logo-talkspace.png" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./img/logo-help.png" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./img/logo-talkspace.png" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./img/logo-help.png" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./img/logo-lemonaid.png" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./svg/blink-logo.svg" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./img/logo-lemonaid.png" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./svg/blink-logo.svg" alt=""></a>
			<a href="#" class="partners-link"><img class="partners-link-logo" src="./img/logo-lemonaid.png" alt=""></a>
		</div>

...
<div class="rs-footer rs-footer-first">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h2 class="h2">Get Free Bonuses Straight to Your Inbox</h2>
				<div class="pre-footer-description">Become a member today to get investing tips to your inbox</div>
			</div>
...
<div class="rs-footer rs-footer-second">
	<div class="container">
		<div class="row footer-nav">
			...
			<div class="col-md-12 footer-nav-block">
				<a class="footer-logo-link" href="homepage.php">
					<?php include('svg/logo-odd-white.svg');?>
				</a>

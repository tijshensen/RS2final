...
<div id="filters-container" class="filters-container">
    ...
    <div class="dropdown">
        <button class="dropdown-toggle btn-filter-search" type="button" id="dropdownFilter<?php echo $key; ?>>" data-toggle="dropdown"
            ...
            <span class="filter-category-mobile"><?php echo $filter['title-mobile']; ?></span> 
            <span class="filter-category"><?php echo $filter['title']; ?></span> 
            <span class="selected"><?php echo $filter['title-filter']; ?></span>

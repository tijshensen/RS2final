...
$logo = "./svg/logoOdd.png";

$rs_states_list = array(
    array ( 
        'pl-flag' => 'flag-California.jpg',
        'pl-state' => 'California',
    ),
    array ( 
        'pl-flag' => 'flag-New-Hampshire.jpg',
        'pl-state' => 'New Hampshire',
    ),
    array ( 
        'pl-flag' => 'flag-Nevada.jpg',
        'pl-state' => 'Nevada',
    ),
    array ( 
        'pl-flag' => 'flag-Delaware.jpg',
        'pl-state' => 'Delaware',
    ),
    array ( 
        'pl-flag' => 'flag-Illinois.jpg',
        'pl-state' => 'Illinois',
    ),
    array ( 
        'pl-flag' => 'flag-Iowa.jpg',
        'pl-state' => 'Iowa',
    ),
    array ( 
        'pl-flag' => 'flag-NewJersey.png',
        'pl-state' => 'New Jersey',
    ),
    array ( 
        'pl-flag' => 'flag-Pennsylvania.jpg',
        'pl-state' => 'Pennsylvania',
    ),
    array ( 
        'pl-flag' => 'flag-RhodeIsland.jpg',
        'pl-state' => 'Rhode Island',
    ),
    array ( 
        'pl-flag' => 'flag-WestVirginia.jpg',
        'pl-state' => 'West Virginia',
    ),
);

$rs_state = array(
    array ( 
        'flag' => 'flag-California.jpg',
        'filter' => 'California',
        'name' => 'California',
        'name-mobile' => 'CA',
        'radio-name' => 'state'
...
$rs_providers_list = array(
    array (
        'pl-filters' => ' ',
        'pl-name' => 'Betfair Casino',
        'pl-logo' => 'company-logo-1.png',
        'pl-list-title' => 'Key Features',
        'pl-list-item-1' => 'Most Popular ',
        'pl-list-item-2' => '12 years in Business',
        'pl-list-item-3' => 'Absolutely mindblowing',
        'pl-price' => '$1500 FREE',
        'pl-price-description' => 'UP TO',
        'pl-lable' => 'Bonusseeker',
        'pl-adition' => 'Enter code on signup',
        'pl-benefit-title' => 'Bonus',
        'pl-top-label-left' => '<img src="./img/top.png" alt=""> ',
        'pl-top-label-right' => ''
    ),
    array (
        'pl-filters' => '',
        'pl-name' => 'Borgata Online Casino',
        'pl-logo' => 'company-logo-2.png',
        'pl-list-title' => 'Key Features',
        'pl-list-item-1' => 'Most Popular ',
        'pl-list-item-2' => '12 years in Business',
        'pl-list-item-3' => 'Absolutely mindblowing',
    ...
    array (
        'pl-filters' => '',
        'pl-name' => 'Golden Nugget Casino',
        'pl-logo' => 'company-logo-3.png',
        'pl-list-title' => 'Key Features',
        'pl-list-item-1' => 'Most Popular ',
        'pl-list-item-2' => '12 years in Business',
        'pl-list-item-3' => 'Absolutely mindblowing',
    ...
    array (
        'pl-filters' => '',
        'pl-name' => 'Caesars Online Casino',
        'pl-logo' => 'company-logo-4.png',
        'pl-list-title' => 'Key Features',
        'pl-list-item-1' => 'Most Popular ',
        'pl-list-item-2' => '12 years in Business',
        'pl-list-item-3' => 'Absolutely mindblowing',
    ...
    array (
        'pl-filters' => '',
        'pl-name' => 'Tropicana Online Casino',
        'pl-logo' => 'company-logo-5.png',
        'pl-list-title' => 'Key Features',
        'pl-list-item-1' => 'Most Popular ',
        'pl-list-item-2' => '12 years in Business',
        'pl-list-item-3' => 'Absolutely mindblowing',
...
$rs_provider_link = array(
    array(
        'provider_logo' => 'company-logo-4.png',
    ),
    array(
        'provider_logo' => 'company-logo-1.png',
    ),
    array(
        'provider_logo' => 'company-logo-2.png',
    ),
    array(
        'provider_logo' => 'company-logo-3.png',
    ),
    array(
        'provider_logo' => 'company-logo-4.png',
    ),
...
$rs_news_cards = array(
    ...
    array(
        'news_img' => 'news-4.png',
        'news_label' => 'Investment guides',
        'news_label_class' => 'green',
        'news_title' => 'ESPN Inks New Partnerships With DraftKings and Caesars Entertainment',
        // 'news_category' => "Men's health",
        'news_author' => 'By Jon Bon Jovi',
        // 'news_date' => '05/07/20',
        'news_time' => 'March 25th, 2020  '

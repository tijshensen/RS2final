		...
		<div class="row  justify-content-center">
			<div class="col-md-10">
				<div class="section-header">
                    ...
                    <h2 class="h2"><span>Depression </span> Treatment</h2>
                    ...
                    <div class="number-lable-block">
                        <a href="#health-apps-section" class="simple-card-block">
                            <span class="block-number">12</span>
                            <span class="block-description">Health apps</span>
                        </a>
                        <a href="#online-therapy-section" class="simple-card-block">
                            <span class="block-number">12</span>
                ...
                <div class="row">
                    <div class="col-lg-4 provider-logo-block">
                        ...
                        <div class="special-info-block">
                            ...
                            <!-- <span class="info green mobi">20% OFF FIRST PURCHASE</span> -->
                            <span class="info red full">#1 Depression treatment</span>
                        </div>
...
<section class="carousel-section" id="health-apps-section">
	<div class="container">
        <div class="row dr-header">
            <img src="./img/dr-finger-big.png" alt="" class="dr-img">
            ...
            <!-- <img src="./img/dr-finger.png" alt="" class="dr-img visible-none"> -->
        </div>
        <div class="row  justify-content-center">
...
<section class="carousel-section" id="online-therapy-section">
	<div class="container">
        <div class="row  justify-content-center">
            ...
            <!--  -->
            <!-- <div class="col-12">
                <div class="btn btn-toggle-filter mx-auto" id="toggle-filter">
